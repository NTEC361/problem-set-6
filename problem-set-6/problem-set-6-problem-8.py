...
# YOUR NAME
# Spring 2022
# problem-set-6-problem-8.py

# INSTRUCTIONS

# There are 11 items that you need to complete.

# Add a comment above or to the right of each line of code describing what it does.
...
def main():
    ...
    # 5) Write Python code below to iterate over the str1 and print each character
    ...
    # Append 4 additional elements to the list, one at a time.
    # Your code goes here. Please do not remove this comment.

    # 9) Write Python code that demonstrates parsing of an input phrase into words in a list'
    # Your code goes here

    # 10) Write Python code that gets pi from the math library and outputs as "3.14"
    # using string formatting for this. You can also use the Python round() function if you want.
    # Your code goes here. Please do not remvoe this comment.

    # 11) In the Python code below, what does line[:-1] evaluate to?
    # You should assume infile has been opened for reading a text file.
    # Also assume that the infile file is a text file with multiple lines, each line ending with
